...
import { ICustomerModalEditState } from '../Models/ICustomerModalEditState';



export class ModalEditCustomer extends React.Component<{}, ICustomerModalEditState> {
    public state: ICustomerModalEditState = {
        showModal: false,
        key: "",
        name: "",
        value: "",
