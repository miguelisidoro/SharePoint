...
export default class BirthdaysWorkAnniversariesNewCollaborators extends React.Component<IBirthdaysWorkAnniversariesNewCollaboratorsProps, {}> {
  public render(): React.ReactElement<IBirthdaysWorkAnniversariesNewCollaboratorsProps> {
    return (
      <div className={ styles.birthdaysWorkAnniversariesNewCollaborators }>
