declare interface IBirthdaysWorkAnniversariesNewCollaboratorsWebPartStrings {
  ...
  NewCollaboratorsInformationTypeLabel: string;
  TodayLabel: string;
...
declare module 'BirthdaysWorkAnniversariesNewCollaboratorsWebPartStrings' {
  const strings: IBirthdaysWorkAnniversariesNewCollaboratorsWebPartStrings;
  export = strings;
}
